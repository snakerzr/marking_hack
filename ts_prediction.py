...
general_info_ = '''С помощью этого сервиса можно рассчитать спрос на определенную продукцию в определенном регионе на выбранное количество месяцев при помощи машинного обучения.
...
* Оптимизация закупок
* Сокращение издержек 
* Избежание переплаты за товары, которые не будут использованы
* Избежание дефицита товаров, необходимых для реализации гос. программ и проектов'''

business_benefit_ = '''### Польза для бизнеса:

* Оптимизация производственных процессов и эффективное управление запасами товаров.
